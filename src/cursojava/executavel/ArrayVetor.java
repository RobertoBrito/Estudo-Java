...
public class ArrayVetor {
	...
	public static void main(String[] args) {
		...
		// Array pode ser de todos os tipos de dados e objetos tmbém
		/* criação do aluno */
...
//----------------------------------------------------------------------------------------------
		 ...
		 * +", matriculado na escola " + aluno.getNomeEscola());
		 ...
		 * if (pos == 0) { notamax = disc.getNota()[pos]; } else { if
		 * (disc.getNota()[pos] > notamax) { notamax = disc.getNota()[pos]; } } if(pos
		 * ==0) { notamin = disc.getNota()[pos]; } else { if(disc.getNota()[pos] <
		 * notamin) { notamin = disc.getNota()[pos]; } }
		 * 
		 * } System.out.println("A menor nota da Disciplina= " + disc.getDisciplina() +
		 * " e de valor : " + notamin);
		 * System.out.println("A maior nota da Disciplina= " + disc.getDisciplina() +
		 * " e de valor : " + notamax); }
		 * 
		 * 
		 ...
		 * 
		 * String[] teste = new String[4]; String[]teste1 =
		 * {"Roberto","90","Curso","contato@gmail.com"}; teste1[0]="Roberto";
